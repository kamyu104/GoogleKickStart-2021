...
|D| [Dependent Events](https://codingcompetitions.withgoogle.com/kickstart/round/0000000000435914/00000000008d9970)| [Python](./Round%20H/dependent_events.py) | _O(NlogN + QlogN)_ | _O(NlogN)_ | Hard | | Euler's Theorem, Fermat's Little Theorem, Probability, LCA, Tree Ancestors (Binary Lifting) |