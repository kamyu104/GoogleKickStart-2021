...
|D| [Truck Delivery](https://codingcompetitions.withgoogle.com/kickstart/round/0000000000435a5b/000000000077a885)| [PyPy](./Round%20B/truck_delivery.py) | _O((N + R) * log(min(MAX_L, MAX_W)))_ | _O(min(MAX_L, MAX_W))_ | Medium | | DFS, Segment Tree |